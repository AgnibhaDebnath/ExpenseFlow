...
const getTransactionsService = async (type, category,search,dateFilter,user) => {
    ...
    const transactions = await Transaction.find(filter).select("-__v").sort({ date: -1 }).lean()
...
export {createTransactionService,getTransactionsService,updateTransactionService,deleteTransactionService}